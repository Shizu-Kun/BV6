...
if (!roof.pilih2) Fernazerini.sendText(roof.p2, '_Tu oponente ha elegido_\nAhora es tu turno', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
m.reply(`tu has elegido ${m.text} ${!roof.pilih ? `\n\Espera a que el oponente elija` : ''}`)
if (!roof.pilih) Fernazerini.sendText(roof.p, '_Tu oponente ha elegido_\nAhora es tu turno', 0)
}
...
menuu = `👋Hola, ${salam} @${m?.sender.split('@')[0]} Soy ${global.botname}, Estoy lista para ayudarte en tus actividades diarias 😀.
    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            ...
            {
                "name": "quick_reply",
                "buttonParamsJson": `{"display_text":" MENU","id":"${prefix}allmenu"}`
              },                       
              {
                "name": "quick_reply",
...
if (!isRegistered) return reply(mess.regis)
let limitz = db.data.users[m.sender].limit;
menuu = `Soy ${global.botname}, Estoy lista para ayudarte en tus actividades diarias 😀.
  ...
  viewOnceMessage: {
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('./asset/image/thum.jpeg')}, { upload: Fernazerini.waUploadToServer})), 
                  title: `👋Hola ${salam} @${m?.sender.split('@')[0]}`,
                  gifPlayback: true,
                  subtitle: ownername,
                  hasMediaAttachment: false  
                }),
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            ...
            {
                "name": "quick_reply",
                "buttonParamsJson": `{"display_text":"DEVOLVER","id":"${prefix}menu"}`
              },              
           ],
          }),
          contextInfo: {
...
reply(`Sea cortés al llamar a las personas, al menos diga "Assalamu'alaikum warrahmatullahi Wabarakatuh" o puede llamarlos por su nombre. Eso no es educado. Si *eres mayor* lo entiendes.
